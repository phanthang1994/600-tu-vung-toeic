                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('chu_de.edits',$item->id)}}" class="btn btn-primary editbtn btn-sm">Edit</a></td>
                                <td><a type="button" value="' + item.ID + '" class="btn btn-danger deletebtn btn-sm">Delete</a></td>
                            </tr>
                            @endforeach
                            </thead>
                            <tbody>
