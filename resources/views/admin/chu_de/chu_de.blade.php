        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title add_new" id="AddStudentModalLabel">Add Chu De</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label>Category Hiện Tại : <span id="category_hien_tai"> </span></label>
                    </div>
                    <div class="form-group">
                        <label for="">Category Mới</label>
                    ...
                    <div class="card-header">
                        <h4>
                            ...
                            <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal"
                                    data-bs-target="#AddStudentModal">Add Chủ Đề</button>
                        </h4>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetchcategory() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{route('chu_de.category_join')}}",
                    dataType: "json",
                    success: function (response) {
                        // console.log(response);
                        $.each(response.categories, function (key, item) {
                            $('#select_add').append(new Option(item.CATEGORY_NAME, item.ID));
                            $('#select_add_update').append(new Option(item.CATEGORY_NAME, item.ID));
                        }
                        );
                    }
                });
            ...
            $(document).on('click', '.add_student', function (e) {
                ...
                var data = {
                    'chu_de_name': $('.name').val(),
                    'category_id':  $('#select_add').find(":selected").val(),
                    'image': $('.image').val(),
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == 404) {
                            ...
                            console.log(response);
                            $('#name').val(response.student.CHU_DE_NAME)
                            $('#category_hien_tai').html(response.category_name)
            ...
            $(document).on('click', '.update_student', function (e) {
                ...
                var data = {
                    'chu_de_name': $('#name').val(),
                    'category_id':  $('#select_add_update').find(":selected").val(),
