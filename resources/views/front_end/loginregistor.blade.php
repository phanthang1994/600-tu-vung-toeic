                            ...
                            <div class="login-form-container" style=" border-radius: 15px;">
                                <div class="login-register-form">
                                    <form action="{{route('user_register')}}" method="post">
                                        {{ csrf_field() }}
                                        <input name="email" placeholder="Email" type="email" style="border-radius: 15px;">
                                        <input type="text" name="name" placeholder="Username" style="border-radius: 15px;">
                                        <input type="password" name="password" placeholder="Password" style="border-radius: 15px;">
                                        <div class="button-box">
                                            <div class="login-toggle-btn">
                                                <input type="checkbox">
                            ...
                            <div class="login-form-container" style=" border-radius: 15px;">
                                <div class="login-register-form">
                                    <form action="#" method="post">
                                        <input type="text" name="old-user" placeholder="Old user name" style="border-radius: 15px;">
                                        <input type="text" name="new-user" placeholder="New user name" style="border-radius: 15px;">
                                        <div class="button-box">
                                            <div class="login_group" style="">
...
{{--                                            <div class="login_group" style="">--}}
{{--                                                <button class="default-btn" type="submit">Tải ảnh</button>--}}
{{--                                            </div>--}}
